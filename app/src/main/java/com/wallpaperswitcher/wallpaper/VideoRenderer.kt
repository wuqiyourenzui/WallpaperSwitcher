...
/**
 * OpenGL video renderer - single instance, reused across video switches.
 * EGL context lives for the lifetime of this object.
 */
class VideoRenderer {
    ...
    /**
     * Initialize EGL + OpenGL. Call from the thread that will render.
     */
    ...
    /**
     * Configure scale mode for given video dimensions.
     */
    ...
    /**
     * Render current SurfaceTexture frame to screen.
     */
